...
module.exports = {
  checkCreateProductSchema: yup.object({
    body: yup.object({
      ...
      categoryId: yup.string().required().test('Validate ObjectID', '${path} is not valid', (value) => {
        // if (!value) return true;
        return ObjectId.isValid(value);
      }),
  
      supplierId: yup.string().required().test('Validate ObjectID', '${path} is not valid', (value) => {
        // if (!value) return true;
        return ObjectId.isValid(value);
      }),
    }),
